...
class RatingOutput:
    def __init__(self, base, bias=1600.0):
        self.base = base
        ...
        self.html_path = {"1": "html_renju", "2": "html_gomoku"}[self.rule_category]
        ...
        self.ua_ga = {"1": "UA-119927498-1", "2": "UA-173435487-1"}[self.rule_category]
    ...
    def gen_ratings(self, active_level=1, day=None, country_id=None):
        ...
        for player, rating in ratings:
            ...
            if day is None:
                ...
                women_start = (
                    date(1970, 1, 1) + timedelta(day)
                ).year >= self.women_start_year
            if (is_established and is_active) or (not active_level > 0):
                ...
                if country_id is None and active_level == 1:
                    ...
                    if (
                        women_start
                        and female
                        and cur_rank_women <= 12
                        and top_rating_women - rating <= 165
                    ):
        ...
        if day == None:
            if active_level == 1:
                if country_id is None:
                    title = (
                        f"Whole History Rating (WHR) of Active {self.this_name} Players"
                    )
                    dst = self.rating_path
                else:
                    title = (
                        f"Whole History Rating (WHR) of Active {self.this_name} Players in %s"
                ...
                if country_id is None:
                    ...
                    title = (
                        f"Whole History Rating (WHR) of Active {self.this_name} Players in %s (Gy1≥10)"
                        % (self.base.countries[country_id]["name"])
                    )
                ...
                if country_id is None:
                    title = (
                        f"Whole History Rating (WHR) of All {self.this_name} Players"
                    )
                    dst = self.rating_all_path
                else:
                    title = (
                        f"Whole History Rating (WHR) of All {self.this_name} Players in %s"
                        % (self.base.countries[country_id]["name"])
                    )
            ...
            if active_level == 1:
                if country_id is None:
                    title = (
                        f"Whole History Rating (WHR) of Active {self.this_name} Players (%04d-%02d-%02d)"
                        % (date_.year, date_.month, date_.day)
                    )
                    dst = self.rating_date_path % (date_.year, date_.month, date_.day)
                else:
                    title = (
                        f"Whole History Rating (WHR) of Active {self.this_name} Players in %s (%04d-%02d-%02d)"
                        % (
                            self.base.countries[country_id]["name"],
                            date_.year,
                            date_.month,
                ...
                if country_id is None:
                    title = (
                        f"Whole History Rating (WHR) of Active {self.this_name} Players (%04d-%02d-%02d) (Gy1≥10)"
                        % (date_.year, date_.month, date_.day)
                    )
                    dst = self.rating_gy1_date_path % (
                        date_.year,
                        date_.month,
                        date_.day,
                    )
                    ...
                    title = (
                        f"Whole History Rating (WHR) of Active {self.this_name} Players in %s (%04d-%02d-%02d) (Gy1≥10)"
                        % (
                            self.base.countries[country_id]["name"],
                            date_.year,
                            date_.month,
                ...
                if country_id is None:
                    title = (
                        f"Whole History Rating (WHR) of All {self.this_name} Players (%04d-%02d-%02d)"
                        % (date_.year, date_.month, date_.day)
                    )
                    dst = self.rating_all_date_path % (
                        date_.year,
                        date_.month,
                        date_.day,
                    )
                    ...
                    title = (
                        f"Whole History Rating (WHR) of All {self.this_name} Players in %s (%04d-%02d-%02d)"
                        % (
                            self.base.countries[country_id]["name"],
                            date_.year,
                            date_.month,
        ...
        with tag("p"):
            ...
            with tag(
                    ...
                    if active_level == 1:
                        ...
                        if country_id is None:
                            ...
                            line(
                                "option",
                                "Current",
                                value=self.rating_gy1_country_path % country_id,
                                selected="selected",
                            )
                    elif active_level == 0:
                        if country_id is None:
                            ...
                            line(
                                "option",
                                "Current",
                                value=self.rating_all_country_path % country_id,
                                selected="selected",
                            )
                else:
                    if active_level == 1:
                        ...
                        if country_id is None:
                            line("option", "Current", value=self.rating_gy1_path)
                        else:
                            line(
                                "option",
                                "Current",
                        ...
                        if country_id is None:
                            line("option", "Current", value=self.rating_all_path)
                        else:
                            line(
                                "option",
                                "Current",
                ...
                for year in range(self.base.date.year - 1, self.start_year - 1, -1):
                        ...
                        if active_level == 1:
                            if country_id is None:
                                line(
                                    "option",
                                    "%04d" % year,
                                    value=self.rating_date_path % (year, 12, 31),
                                    selected="selected",
                                )
                            else:
                                line(
                            ...
                            if country_id is None:
                                line(
                                    "option",
                                    "%04d" % year,
                                    value=self.rating_gy1_date_path % (year, 12, 31),
                                    selected="selected",
                                )
                            else:
                                line(
                            ...
                            if country_id is None:
                                line(
                                    "option",
                                    "%04d" % year,
                                    value=self.rating_all_date_path % (year, 12, 31),
                                    selected="selected",
                                )
                            else:
                                line(
            ...
            with tag(
                    ...
                    if active_level == 1:
                        if day is None:
                            ...
                            line(
                                "option",
                                "All",
                                value=self.rating_date_path % (cur_year, 12, 31),
                                selected="selected",
                            )
                    elif active_level == 2:
                        if day is None:
                            ...
                            line(
                                "option",
                                "All",
                                value=self.rating_gy1_date_path % (cur_year, 12, 31),
                                selected="selected",
                            )
                    elif active_level == 0:
                        if day is None:
                            ...
                            line(
                                "option",
                                "All",
                                value=self.rating_all_date_path % (cur_year, 12, 31),
                                selected="selected",
                            )
                else:
                    if active_level == 1:
                ...
                sorted_country_list = sorted(
                    self.country_set, key=lambda x: self.base.countries[x]["name"]
                )
                    ...
                    if country_id != None and country_id == list_country_id:
                        if active_level == 1:
                            if day is None:
                                line(
                                    "option",
                                    self.base.countries[list_country_id]["name"],
                                    value=self.rating_country_path % list_country_id,
                                    selected="selected",
                                )
                            else:
                                cur_year = (date(1970, 1, 1) + timedelta(day)).year
    ...
    def gen_ljratings(self):
        ...
        ljcountry_dict = {}
        ljcountry_name = os.path.join(self.save_path, "data", self.ljcountry_name)
    ...
    <![endif]-->"""
                ...
                doc.stag(
                    "meta",
                    name="keywords",
                    content=f"{self.this_name}, {self.this_name} rating, whole-history rating, WHR",
                )
                doc.stag(
                    "meta",
                    name="description",
                ...
                doc.stag(
                    "meta",
                    name="copyright",
                    content=f"%d {self.this_name} Rating" % self.base.date.year,
                )
    ...
    """
                ...
                doc.stag(
                    "link", href="css/ljrenju.css", rel="stylesheet", type="text/css"
                )
            with tag("body"):
    ...
    def gen_players(self):
        players = sorted(
            self.base.players.items(), key=lambda x: self.base.round_to_key(x[0])
        )
    ...
    def gen_players_json(self):
        ...
        for player, rating in ratings:
            ...
            outputs.append([int(player), rank, rating + self.bias, int(is_established)])
    ...
    def gen_player(self):
        ...
        for player_id, ratings_player in ratings.items():
            ...
            top_rating_date, top_rating, _ = max(ratings_player, key=lambda x: x[1])
            ...
            rating_chart = "".join(
                map(
                    lambda r: "{x: %d, y: %f}, " % (r[0] * 86400000, r[1] + self.bias),
                    rating,
                )
            )
            tournament_outputs = []
            for tournament_id, games in reversed(history):
                ...
                rating_in_tournament = (
                    next(filter(lambda x: x[0] == tournament_end_day, rating))[1]
                    + self.bias
                )
                game_outputs = []
                for game_id in games:
                    ...
                    opponent_country = self.base.countries[opponent["country"]]["abbr"]
                    opponent_rating = (
                        next(
                            filter(
                                lambda x: x[0] == tournament_end_day,
                                ratings[opponent_id],
                            )
                        )[1]
                        + self.bias
            ...
            with tag("p"):
                doc.asis(
                    "<b>Top rating:</b> %.2f (%04d-%02d-%02d)"
                    % (
                        round(top_rating, 2),
                        top_rating_date.year,
                        top_rating_date.month,
                        top_rating_date.day,
                    )
                )
            with tag("p"):
            ...
            with tag("p"):
                doc.asis(
                    "<b>Gy1:</b> %d, <b>Gy2:</b> %d, <b>Gy5:</b> %d" % (gy1, gy2, gy5)
                )
                            ...
                            with tag("tr"):
                                    ...
                                    if result == 1:
                                        with tag("td", klass="win"):
                                            line(
                                                "a",
                                                "Win",
                                                href=self.game_path % output_game_id,
                                            )
                                    elif result == 0:
                                ...
                                with tag("td"):
                                    ...
                                    if not opponent_female:
                                        line(
                                            "a",
                                            "%s %s" % (opponent_surname, opponent_name),
                                            href=self.player_path % opponent_id,
...
<script>
    ...
    def gen_tournaments(self):
        tournaments = sorted(
            ...
            key=lambda x: (x[1]["end"], x[1]["start"], self.base.round_to_key(x[0])),
            reverse=True,
        )
        ...
        for tournament_id, tournament in tournaments:
            ...
            outputs.append(
                [tournament_id, name, country, country_name, city, ngames, start, end]
            )
        doc, tag, text, line = Doc().ttl()
        with tag("table"):
            with tag("tbody"):
                ...
                for (
                    ...
                    with tag("tr"):
                        ...
                        with tag("td"):
                            line("a", name, href=self.tournament_path % tournament_id)
    ...
    def gen_tournament(self):
        ...
        for tournament_id, tournament in self.base.tournaments.items():
            ...
            for game_id in games_for_tournaments[tournament_id]:
                ...
                black_country = self.base.countries[black_player["country"]]["abbr"]
                black_rating = (
                    next(filter(lambda x: x[0] == end_day, self.base.ratings[black]))[1]
                    + self.bias
                )
                ...
                white_country = self.base.countries[white_player["country"]]["abbr"]
                white_rating = (
                    next(filter(lambda x: x[0] == end_day, self.base.ratings[white]))[1]
                    + self.bias
                )
            ...
            round_outputs = sorted(
                round_outputs.items(), key=lambda x: self.base.round_to_key(x[0])
            )
            for round_, game_outputs in round_outputs:
                game_outputs.sort(
                    key=lambda g: (max(g[5], g[12]), min(g[5], g[12])), reverse=True
                )
            doc, tag, text, line = Doc().ttl()
            line("h1", name)
            with tag("p"):
                    ...
                    for round_, game_outputs in round_outputs:
                        ...
                        for (
                            ...
                            with tag("tr"):
                                ...
                                line("td", "%.2f" % round(black_rating, 2), klass="num")
                                if output_game_id is None:
                                ...
                                line("td", "%.2f" % round(white_rating, 2), klass="num")
                                with tag("td", klass="right"):
                                    if not white_female:
                                        line(
                                            "a",
                                            "%s %s" % (white_surname, white_name),
    ...
    def gen_top_ratings(self, female=False):
        if not female:
            top_players = sorted(
                self.top_players.keys(), key=lambda p: self.top_players[p], reverse=True
            )
        else:
            top_players = sorted(
                self.top_players_women.keys(),
            ...
            str_chart = "".join(
                map(
                    ...
                    filter(
                        lambda r: r[0]
                        >= int(
                            datetime(start_year, 1, 1, tzinfo=timezone.utc).timestamp()
                        )
                        // 86400,
                        rating,
                    ),
...
<script>
                    ...
                    with tag("div", id="menu"):
                        with tag("ul"):
                            for page_title, page_href, is_first in [
                                ...
                                ("History of Top players", self.top_rating_path, False),
                                (
                                    "History of Top Women",
                                    self.top_rating_women_path,
                                    False,
                                ),
    ...
    def gen_sitemap(self):
        ...
        fout = open(
            os.path.join(self.save_path, self.html_path, self.sitemap_path),
            "w",
            encoding="utf-8",
        )
